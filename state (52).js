...
const SCHOOLS = [
  { name: 'Harvard University', aka: ['harvard'], tier: 'reach', accept: '~3%', region: 'Cambridge, MA',
    ...
    guidance: 'Harvard rejects the vast majority of valedictorians - grades and scores get you considered, not admitted. What separates admits is a genuine, deep "spike" (a demonstrated, exceptional strength in one area) plus evidence you affect the people around you. Its motto "Veritas" (truth) rewards intellectual honesty and real curiosity - reference the value through your own experience, never by name-dropping.',
    acceptedPattern: 'Public analyses of admitted students consistently show a clear spike, usually built from extracurriculars and honors rather than coursework - e.g. an admit who progressed over four years from environmental-club member to regional coordinator, showing rising responsibility and measurable impact. The pattern that recurs: sustained depth in one or two things, framed around real, quantifiable change - not a long list of shallow memberships.' },
  { name: 'Stanford University', aka: ['stanford'], tier: 'reach', accept: '~4%', region: 'Stanford, CA',
    motto: '"Die Luft der Freiheit weht" — German for "the wind of freedom blows," chosen by Stanford\'s first president to enshrine fearless, unfettered inquiry ("studies blossom and the minds move").',
    values: ['intellectual vitality','initiative','a distinctive angle','building things'],
    guidance: 'Stanford prizes intellectual curiosity for its own sake and students who build or start things - its "intellectual vitality" essay directly probes this. The motto ("the wind of freedom blows") reflects a culture of fearless inquiry, so a self-started project or genuine intellectual obsession reads far stronger than a prestigious-but-passive membership.',
    acceptedPattern: 'Admitted profiles tend to show a distinctive personal angle - the "what makes you, you" - and evidence of self-directed initiative (a founded project, a pursued curiosity taken further than assigned). Depth and an authentic, specific voice in the essays recur far more than a broad résumé.' },
  { name: 'Massachusetts Institute of Technology (MIT)', aka: ['mit','massachusetts institute of technology'], tier: 'reach', accept: '~4%', region: 'Cambridge, MA',
  ...
  { name: 'Princeton University', aka: ['princeton'], tier: 'reach', accept: '~4%', region: 'Princeton, NJ',
    motto: '"Dei sub numine viget" — "Under God\'s power she flourishes," paired with Princeton\'s informal ethos "in the nation\'s service and the service of humanity."',
    values: ['scholarship','service','intellectual depth','writing'],
    guidance: 'Princeton has a strong undergraduate focus and service ethos ("in the nation\'s service and the service of humanity"). It weighs intellectual depth and strong writing heavily - the graded written paper it requests is read seriously. Sustained scholarship and genuine service commitments matter more than breadth.',
  ...
  { name: 'Yale University', aka: ['yale'], tier: 'reach', accept: '~4%', region: 'New Haven, CT',
    ...
    guidance: 'Yale reads for how you engage ideas and community - it famously weighs "what you\'ll bring to the residential college." A distinctive voice in essays and genuine engagement (including arts and humanities, which Yale values strongly) stand out more than a purely stats-driven profile.',
    acceptedPattern: 'Admitted profiles often show a person who visibly contributes to a community and brings a distinctive voice - Yale wants to picture what you add to its residential-college life. Engagement and character recur as much as raw achievement.' },
  { name: 'University of California, Berkeley', aka: ['uc berkeley','berkeley','cal'], tier: 'reach', accept: '~11%', region: 'Berkeley, CA',
  ...
  { name: 'Georgia Institute of Technology', aka: ['georgia tech','gatech','georgia institute of technology'], tier: 'target', accept: '~16%', region: 'Atlanta, GA',
  ...
  { name: 'University of Michigan', aka: ['michigan','umich','university of michigan'], tier: 'target', accept: '~18%', region: 'Ann Arbor, MI',
  ...
  { name: 'Carnegie Mellon University', aka: ['carnegie mellon','cmu'], tier: 'reach', accept: '~11%', region: 'Pittsburgh, PA',
  ...
  { name: 'New York University (NYU)', aka: ['nyu','new york university'], tier: 'target', accept: '~12%', region: 'New York, NY',
  ...
  { name: 'University of California, Los Angeles (UCLA)', aka: ['ucla','uc los angeles'], tier: 'reach', accept: '~9%', region: 'Los Angeles, CA',
    motto: '"Fiat Lux" — Latin for "Let there be light."',
  ...
  { name: 'State flagship / public university', aka: ['state school','public university','state flagship'], tier: 'target', accept: 'varies', region: 'Varies',
    motto: 'Varies by school — many state flagships center a "access + excellence" public-service mission.',
    values: ['solid grades and rigor','a clear intended focus','well-rounded record'],
    ...
    acceptedPattern: 'Admits generally clear a GPA/rigor bar with a coherent academic record; honors-college admits additionally show the kind of depth and essays selective privates look for.' },
];
