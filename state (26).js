...
async function analyzeStrategicPositionJS(profile, roadmapMilestones, applications, savedListings){
...
async function getOrAnalyzeStrategicPositionJS(profile, roadmapMilestones, applications, savedListings){
  ...
  const fresh = await analyzeStrategicPositionJS(profile, roadmapMilestones, applications, savedListings);
