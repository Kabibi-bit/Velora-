...
function auditPersonalizationEffect(applicationsWithOutcomes){
  ...
  if(comparable.length < 3){
    return { verdict: 'insufficient_data', sampleSize: comparable.length, note: `Not enough applications yet where personalization actually changed the score by a meaningful amount - need at least 3 to draw a real conclusion, have ${comparable.length}.` };
  }
  ...
  return {
    verdict, sampleSize: comparable.length,
