...
function getAthleteApplications(){ try{ const v = JSON.parse(localStorage.getItem('velora_athlete_applications')); return Array.isArray(v) ? v : []; }catch(e){ return []; } }
...
function getAdmissionsApplications(){ try{ const v = JSON.parse(localStorage.getItem('velora_admissions_applications')); return Array.isArray(v) ? v : []; }catch(e){ return []; } }
...
function getApplications(){ try{ const _v = JSON.parse(localStorage.getItem('velora_applications')); return Array.isArray(_v) ? _v : []; }catch(e){ return []; } }
...
function getResumeEntries(){ try{ const _v = JSON.parse(localStorage.getItem('velora_resume_entries')); return Array.isArray(_v) ? _v : []; }catch(e){ return []; } }
...
function getOutcomes(){ try{ const v = JSON.parse(localStorage.getItem('velora_outcomes')); return Array.isArray(v) ? v : []; }catch(e){ return []; } }
