  ...
  root.innerHTML = `
    <nav class="nav">
      <div class="wrap nav-inner">
        ...
        ${session
          ? `<div class="nav-account"><a class="nav-account-email" href="plan.html" title="Your plan &amp; account">${session.email}</a><a class="nav-link" href="#" id="navLogoutLink">Log out</a></div>`
          : ''}
      </div>
    </nav>`;
