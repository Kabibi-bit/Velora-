...
const SCHOOLS = [
  // ===================== US — reaches (T10-ish) =====================
  { name: 'Harvard University', aka: ['harvard'], country: 'US', tier: 'reach', accept: '~3.6%', region: 'Cambridge, MA',
  ...
  { name: 'Stanford University', aka: ['stanford'], country: 'US', tier: 'reach', accept: '~4%', region: 'Stanford, CA',
  ...
  { name: 'Massachusetts Institute of Technology (MIT)', aka: ['mit','massachusetts institute of technology'], country: 'US', tier: 'reach', accept: '~4%', region: 'Cambridge, MA',
  ...
  { name: 'California Institute of Technology (Caltech)', aka: ['caltech','california institute of technology'], country: 'US', tier: 'reach', accept: '~3.8%', region: 'Pasadena, CA',
  ...
  { name: 'Princeton University', aka: ['princeton'], country: 'US', tier: 'reach', accept: '~4%', region: 'Princeton, NJ',
  ...
  { name: 'Yale University', aka: ['yale'], country: 'US', tier: 'reach', accept: '~4%', region: 'New Haven, CT',
  ...
  { name: 'University of Pennsylvania (UPenn)', aka: ['upenn','penn','university of pennsylvania'], country: 'US', tier: 'reach', accept: '~6%', region: 'Philadelphia, PA',
  ...
  { name: 'Columbia University', aka: ['columbia'], country: 'US', tier: 'reach', accept: '~4%', region: 'New York, NY',
  ...
  { name: 'Brown University', aka: ['brown'], country: 'US', tier: 'reach', accept: '~5%', region: 'Providence, RI',
  ...
  { name: 'Dartmouth College', aka: ['dartmouth'], country: 'US', tier: 'reach', accept: '~5.3%', region: 'Hanover, NH',
  ...
  // ===================== US — reaches/targets (T10-30) =====================
  { name: 'Duke University', aka: ['duke'], country: 'US', tier: 'reach', accept: '~6%', region: 'Durham, NC',
  ...
  { name: 'Johns Hopkins University', aka: ['johns hopkins','jhu','hopkins'], country: 'US', tier: 'reach', accept: '~6%', region: 'Baltimore, MD',
  ...
  { name: 'Northwestern University', aka: ['northwestern'], country: 'US', tier: 'reach', accept: '~7%', region: 'Evanston, IL',
  ...
  { name: 'University of Chicago', aka: ['uchicago','university of chicago','u chicago'], country: 'US', tier: 'reach', accept: '~5%', region: 'Chicago, IL',
  ...
  { name: 'Cornell University', aka: ['cornell'], country: 'US', tier: 'reach', accept: '~7%', region: 'Ithaca, NY',
  ...
  { name: 'Rice University', aka: ['rice'], country: 'US', tier: 'reach', accept: '~8%', region: 'Houston, TX',
  ...
  { name: 'Vanderbilt University', aka: ['vanderbilt','vandy'], country: 'US', tier: 'reach', accept: '~5%', region: 'Nashville, TN',
  ...
  { name: 'University of Notre Dame', aka: ['notre dame','nd'], country: 'US', tier: 'reach', accept: '~9%', region: 'Notre Dame, IN',
  ...
  { name: 'Georgetown University', aka: ['georgetown'], country: 'US', tier: 'reach', accept: '~12%', region: 'Washington, DC',
  ...
  { name: 'University of California, Berkeley', aka: ['uc berkeley','berkeley','cal'], country: 'US', tier: 'reach', accept: '~11%', region: 'Berkeley, CA',
  ...
  { name: 'University of California, Los Angeles (UCLA)', aka: ['ucla','uc los angeles'], country: 'US', tier: 'reach', accept: '~9%', region: 'Los Angeles, CA',
  ...
  { name: 'University of Michigan', aka: ['michigan','umich','university of michigan'], country: 'US', tier: 'target', accept: '~18%', region: 'Ann Arbor, MI',
  ...
  { name: 'University of North Carolina at Chapel Hill (UNC)', aka: ['unc','unc chapel hill','north carolina'], country: 'US', tier: 'target', accept: '~17%', region: 'Chapel Hill, NC',
  ...
  { name: 'Carnegie Mellon University', aka: ['carnegie mellon','cmu'], country: 'US', tier: 'reach', accept: '~11%', region: 'Pittsburgh, PA',
  ...
  { name: 'Emory University', aka: ['emory'], country: 'US', tier: 'target', accept: '~13%', region: 'Atlanta, GA',
  ...
  { name: 'University of Virginia (UVA)', aka: ['uva','university of virginia','virginia'], country: 'US', tier: 'target', accept: '~17%', region: 'Charlottesville, VA',
  ...
  { name: 'Washington University in St. Louis (WashU)', aka: ['washu','wustl','washington university','washington university in st louis'], country: 'US', tier: 'reach', accept: '~11%', region: 'St. Louis, MO',
  ...
  { name: 'University of Southern California (USC)', aka: ['usc','university of southern california','southern cal'], country: 'US', tier: 'target', accept: '~10%', region: 'Los Angeles, CA',
  ...
  { name: 'New York University (NYU)', aka: ['nyu','new york university'], country: 'US', tier: 'target', accept: '~12%', region: 'New York, NY',
  ...
  { name: 'Tufts University', aka: ['tufts'], country: 'US', tier: 'target', accept: '~10%', region: 'Medford, MA',
  ...
  { name: 'Georgia Institute of Technology', aka: ['georgia tech','gatech','georgia institute of technology'], country: 'US', tier: 'target', accept: '~16%', region: 'Atlanta, GA',
  ...
  // ===================== UK — course-specific, academic model =====================
  { name: 'University of Oxford', aka: ['oxford','oxford university','university of oxford'], country: 'UK', tier: 'reach', accept: '~13% (course-dependent)', region: 'Oxford, England',
  ...
  { name: 'University of Cambridge', aka: ['cambridge','cambridge university','university of cambridge'], country: 'UK', tier: 'reach', accept: '~16% (course-dependent)', region: 'Cambridge, England',
  ...
  { name: 'Imperial College London', aka: ['imperial','imperial college','imperial college london'], country: 'UK', tier: 'reach', accept: '~14% (course-dependent)', region: 'London, England',
  ...
  { name: 'London School of Economics (LSE)', aka: ['lse','london school of economics'], country: 'UK', tier: 'reach', accept: '~9% (course-dependent)', region: 'London, England',
  ...
  { name: 'University College London (UCL)', aka: ['ucl','university college london'], country: 'UK', tier: 'reach', accept: '~30% (course-dependent)', region: 'London, England',
  ...
  { name: 'University of Edinburgh', aka: ['edinburgh','university of edinburgh'], country: 'UK', tier: 'target', accept: 'course-dependent', region: 'Edinburgh, Scotland',
...
function searchSchools(query){
  ...
  return SCHOOLS.filter(s =>
    s.name.toLowerCase().includes(q) || s.aka.some(a => a.includes(q) || q.includes(a))
  ).slice(0, 6);
}
...
function lookupSchool(name){
  ...
  return SCHOOLS.find(s =>
    s.name.toLowerCase() === q || s.aka.includes(q) ||
    s.name.toLowerCase().includes(q) || s.aka.some(a => q.includes(a))
  ) || null;
}
...
function generateAdmissionsRoadmapLocal(admProfile, topOpp){
  ...
  steps.push({
    ...
    description: `Selective admissions reward depth over breadth. Rather than a long list of unrelated clubs, admissions officers look for a clear, demonstrated focus - a "spike" - in ${major}. Naming yours focuses every stage after this.`,
    ...
    risk: `Spreading across many unrelated activities - a focused profile reads far stronger to schools like ${topSchool} than a scattered one.`,
  });
  steps.push({
    title: `Commit to one signature extracurricular`,
    description: `${oppLine} One activity you go deep in - with real responsibility over time - beats five you barely touch. This is the backbone of your application.`,
    success_criteria: 'You have joined (or founded) one activity you will stay committed to for at least a year.',
    ...
    risk: 'Chasing prestige over genuine fit - sustained, real involvement is what actually shows commitment.',
  });
  steps.push({
  ...
  steps.push({
    ...
    description: `Real experience - a lab, an internship, a shadowing program - is what separates a strong applicant from a great one, and gives you specific stories for essays and interviews.`,
  ...
  steps.push({
    ...
    description: `With a real spike, a signature activity, an achievement, and experience, the final stage is execution: essays that tell your specific story, and every deadline for ${schools.length ? schools.slice(0,3).join(', ') : 'your schools'} tracked and met.`,
  ...
  // School-tier-aware closing line, from the KB anchor school.
  const anchorSchool = schools.map(s => lookupSchool(s)).filter(Boolean).sort((a,b) => (a.tier==='reach'?0:1)-(b.tier==='reach'?0:1))[0];
  let schoolTierLine = '';
  if(anchorSchool){
    schoolTierLine = anchorSchool.tier === 'reach'
      ? ` Because ${anchorSchool.name} is a genuine reach (${anchorSchool.accept} admit rate), strong grades and scores only get you considered - what this plan is really building is the depth and evidence that separate admits, especially ${anchorSchool.values.slice(0,2).join(' and ')}.`
      : ` ${anchorSchool.name} (${anchorSchool.accept} admit rate) rewards a solid academic record plus a clear, demonstrated focus - this plan gives you both, which is a realistic and strong target.`;
  }
  const summary = `This plan moves from where you are in ${grade} toward a standout application for ${major}, in ${steps.length} stages. The honest throughline: depth beats breadth at every stage. One real spike, one concrete achievement, and real experience - tracked against real deadlines - matter far more than a long, shallow activity list.${schoolTierLine}`;
