...
async function downloadResumeDocx(){
  ...
  a.href = url; a.download = 'resume.docx';
...
async function analyzeStrategicPositionJS(profile, roadmapMilestones, applications, savedListings, previousAnalysis){
...
function computeStrategyInputSignature(roadmapMilestones, applications, savedListings){
  ...
  return `${roadmapSig}||${appsSig}||${savedSig}`;
}

async function getOrAnalyzeStrategicPositionJS(profile, roadmapMilestones, applications, savedListings){
  ...
  const signature = computeStrategyInputSignature(roadmapMilestones, applications, savedListings);
  let cached = null;
  ...
  const fresh = await analyzeStrategicPositionJS(profile, roadmapMilestones, applications, savedListings, previousAnalysis);
