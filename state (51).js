...
const SCHOOLS = [
  { name: 'Harvard University', aka: ['harvard'], tier: 'reach', accept: '~3%', region: 'Cambridge, MA', values: ['intellectual vitality','a genuine spike','leadership','impact beyond self'],
    guidance: 'Harvard rejects the vast majority of valedictorians - grades and scores get you considered, not admitted. What separates admits is a genuine, deep "spike" (a demonstrated, exceptional strength in one area) plus evidence you affect the people around you. Depth and authentic voice beat a long, dutiful activity list.' },
  { name: 'Stanford University', aka: ['stanford'], tier: 'reach', accept: '~4%', region: 'Stanford, CA', values: ['intellectual curiosity','initiative','a distinctive angle','building things'],
    guidance: 'Stanford prizes intellectual curiosity for its own sake and students who build or start things. It reads for a distinctive personal angle - the "so what makes you, you." A self-started project or venture in your field reads far stronger here than another prestigious-but-passive membership.' },
  { name: 'Massachusetts Institute of Technology (MIT)', aka: ['mit','massachusetts institute of technology'], tier: 'reach', accept: '~4%', region: 'Cambridge, MA', values: ['hands-on making','STEM depth','collaboration','using knowledge for good'],
    guidance: 'MIT wants makers, not just high scorers - concrete evidence you build, tinker, and solve real problems (competitions, projects, research). It genuinely values collaboration and mission ("mens et manus" - mind and hand). A real technical project or olympiad result is more convincing than perfect grades alone.' },
  { name: 'Princeton University', aka: ['princeton'], tier: 'reach', accept: '~4%', region: 'Princeton, NJ', values: ['scholarship','service','intellectual depth','writing'],
    guidance: 'Princeton has a strong undergraduate-focus and service ethos ("in the nation\'s service"). It weighs intellectual depth and strong writing heavily - the graded written paper it requests is read seriously. Sustained scholarship and genuine service commitments matter more than breadth.' },
  { name: 'Yale University', aka: ['yale'], tier: 'reach', accept: '~4%', region: 'New Haven, CT', values: ['intellectual engagement','community impact','distinctive voice','the arts and humanities'],
    guidance: 'Yale reads for how you engage ideas and community - it famously weighs "what you\'ll bring to the residential college." A distinctive voice in essays and genuine engagement (including arts/humanities, which Yale values strongly) stand out more than a purely stats-driven profile.' },
  { name: 'University of California, Berkeley', aka: ['uc berkeley','berkeley','cal'], tier: 'reach', accept: '~11%', region: 'Berkeley, CA', values: ['academic excellence','overcoming challenges','contribution to community','the UC PIQs'],
  ...
  { name: 'Georgia Institute of Technology', aka: ['georgia tech','gatech','georgia institute of technology'], tier: 'target', accept: '~16%', region: 'Atlanta, GA', values: ['STEM rigor','hands-on projects','fit with the major','problem-solving'],
  ...
  { name: 'University of Michigan', aka: ['michigan','umich','university of michigan'], tier: 'target', accept: '~18%', region: 'Ann Arbor, MI', values: ['academic rigor','community contribution','specific "why Michigan"','leadership'],
  ...
  { name: 'Carnegie Mellon University', aka: ['carnegie mellon','cmu'], tier: 'reach', accept: '~11%', region: 'Pittsburgh, PA', values: ['depth in the intended program','technical or artistic portfolio','fit with the specific college','rigor'],
    guidance: 'CMU admits by specific college/program, so depth and fit with your exact intended field is central - a portfolio or concrete body of work (technical or artistic) is often what tips it. Generalist profiles fare worse here than at more holistic schools; go deep in your lane.' },
  { name: 'New York University (NYU)', aka: ['nyu','new york university'], tier: 'target', accept: '~12%', region: 'New York, NY', values: ['genuine fit with NYU\'s global/urban identity','demonstrated interest','academic rigor'],
  ...
  { name: 'University of California, Los Angeles (UCLA)', aka: ['ucla','uc los angeles'], tier: 'reach', accept: '~9%', region: 'Los Angeles, CA', values: ['academic excellence','the UC PIQs','contribution and context','breadth with depth'],
  ...
  { name: 'State flagship / public university', aka: ['state school','public university','state flagship'], tier: 'target', accept: 'varies', region: 'Varies', values: ['solid grades and rigor','a clear intended focus','well-rounded record'],
    guidance: 'Many state flagships weigh GPA, course rigor, and (sometimes) test scores more formulaically than the most selective privates, though honors colleges are more holistic. A solid academic record plus a clear intended focus is often sufficient - useful as a genuine target or safety alongside reaches.' },
];
